              ...
              <div className="flex flex-col h-[46px] items-end justify-center gap-8 px-4 py-0 relative flex-1 grow bg-white rounded-lg">
                <div className="inline-flex items-center justify-center gap-1.5 relative flex-[0_0_auto]">
                  ...
                  <input
                    ...
                    className="relative w-full mt-[-1.00px] [font-family:'Assistant',Helvetica] text-[#545454] text-[13px] tracking-[0] leading-[14px] whitespace-nowrap font-normal [direction:rtl] text-right"
                    required
                    aria-required="true"
                  />
                </div>
